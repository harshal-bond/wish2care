...
export const BREAKFAST_OPTIONS = ['Always', 'Sometimes', 'Never'] as const;
export const FRUIT_INTAKE_OPTIONS = ['Daily', '3-5 per week', 'Rarely'] as const;
export const VEGETABLES_OPTIONS = ['Daily', 'Sometimes', 'Rarely'] as const;
export const PROTEIN_INTAKE_OPTIONS = ['Daily', '3-5 per week', 'Rarely'] as const;
export const JUNK_FOOD_OPTIONS = ['Never', 'Weekly', 'Daily'] as const;
export const SUGARY_DRINKS_OPTIONS = ['Never', 'Weekly', 'Daily'] as const;
export const WATER_INTAKE_OPTIONS = ['More than 2L', '1-2L', 'Less than 1L'] as const;

// ── Lifestyle options ──────────────────────────────────────────────────
export const PHYSICAL_ACTIVITY_OPTIONS = ['Daily', '3-5 per week', 'Rarely'] as const;
export const SCREEN_TIME_OPTIONS = ['Less than 2 hrs', '2-4 hrs', 'More than 4 hrs'] as const;
export const OUTDOOR_PLAY_OPTIONS = ['Daily', '3-5 per week', 'Rarely'] as const;
export const SLEEP_HOURS_OPTIONS = ['8+ hrs', '6-8 hrs', 'Less than 6 hrs'] as const;
export const SMOKING_OPTIONS = ['Never', 'Occasional', 'Regular', 'Not Applicable'] as const;
export const ALCOHOL_OPTIONS = ['Never', 'Occasional', 'Regular', 'Not Applicable'] as const;

// ── Mental Wellness options ────────────────────────────────────────────
export const STRESS_OPTIONS = ['Low', 'Moderate', 'High'] as const;
export const MOOD_OPTIONS = ['Happy', 'Neutral', 'Low'] as const;
export const CONCENTRATION_OPTIONS = ['Good', 'Average', 'Poor'] as const;

// ── Preventive Health options ──────────────────────────────────────────
export const HAND_HYGIENE_OPTIONS = ['Good', 'Average', 'Poor'] as const;
...
export const GROWTH_SCORE_BY_BMI: Record<BmiCategory, number> = {
  Normal: 100,
  Overweight: 65,
  Obese: 50,
  Underweight: 45,
