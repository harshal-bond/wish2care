...
export const physicalCompleteSql = sql<boolean>`((${completedDomainsSql}) = 8)`.mapWith(Boolean);
...
export const caseCompleteSql = sql<boolean>`(
...
export const caseStartedSql = sql<boolean>`(
